...
// MARK: - NSStringStylizerTests Definition

class NSStringStylizerTests: XCTestCase {

    // MARK: Test Methods

    func testStylizeNSString() {
        let font: StylizerNativeFont = .defaultFont

        //

        let markdownString = NSString(string: "**bold**, __bold__, *italic*, _italic_, ~~strikethrough~~, [link](https://www.apple.com), [link](https://www.apple.com \"title\")")
        ...
        let htmlString = NSString(string: "<b>bold</b>, <strong>bold</strong>, <i>italic</i>, <em>italic</em>, <del>strikethrough</del>, <ins>underline</ins>, <sup>superscript</sup>, <p style=\"color:blue;\">text color</p>, <p style=\"background-color:red;\">background color</p>, <a href=\"https://www.apple.com\">link</a>, <a href=\"https://www.apple.com\" title=\"title\">link</a>")
    ...
    func testStylizeNSStringWithNoStylizers() {
        let markdownString = NSString(string: "**bold**, __bold__, *italic*, _italic_, ~~strikethrough~~, [link](https://www.apple.com), [link](https://www.apple.com \"title\")")
        let stylizedMarkdownString = markdownString.stylize(with: [], defaultFont: .defaultFont)

        XCTAssertEqual(markdownString, stylizedMarkdownString.string as NSString)
